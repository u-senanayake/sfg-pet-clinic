...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        owner1.setAddress("123 Iriya 1-Chome");
        owner1.setCity("Adachi-Ku");
        ...
        owner2.setFirstName("Fiano");
        owner2.setLastName("Glanne");
        owner2.setAddress("123 Iriya 2-Chome");
        owner2.setCity("Adachi");
        owner2.setTelephone("987654321");

        Pet fianosCat = new Pet();
        fianosCat.setName("Just Cat");
        fianosCat.setOwner(owner2);
        fianosCat.setBirthDay(LocalDate.now());
